...
Podemos ver que *Mr Robot* não possui uma variação muito notável nas notas de seus episódios. Já em *Black Mirror* é possível notar que a 2ª e 3ª temporada possuem um episódio, em cada, que apresentam uma qualidade bem mais inferior que o restante dos episódios. Inclusive, temos na 2ª temporada o episódio pior avaliado e em seguida temos o melhor avaliado da série, com uma diferença de aproximadamente **2.0**(*The Waldo Moment* tem uma nota 22% menor que a nota do episódio *White Christmas*.
...
>> Bom texto! Senti falta de uma breve explicação sobre o conjunto de dados que foi utilizado, para ajudar a situar o leitor com o texto. Uma sugestão é explicar melhor por que realizar algumas opções, como em escolher somente o recurso visual para explicar a irregularidade das séries ou escolher a série mais bem avaliada como sendo a com maior mediana e não escolher outra medida, por exemplo. Também seria legal utilizar o destaque dado para alguns episódios de modo que isso fosse refletido na representação gráfica, para que fosse possível visualizar a ênfase observada no texto. Também seria legal explicar o significado dos valores numéricos obtidos, para entendermos melhor o que deseja ser dito.
